...
if( ! function_exists( 'sc_before_after' ) )
{
	function sc_before_after( $attr, $content = null )
	{
		...
		$output = '<div class="before_after twentytwenty-container">';
			$output .= '<img class="scale-with-grid" src="'. $image_before .'" alt="" '. mfn_get_attachment_dimensions( mfn_get_attachment_id_url( $image_before ), 'width', 1 ) .' '. mfn_get_attachment_dimensions( mfn_get_attachment_id_url( $image_before ), 'height', 1 ) .' />';
			$output .= '<img class="scale-with-grid" src="'. $image_after .'" alt="" '. mfn_get_attachment_dimensions( mfn_get_attachment_id_url( $image_after ), 'width', 1 ) .' '. mfn_get_attachment_dimensions( mfn_get_attachment_id_url( $image_after ), 'height', 1 ) .' />';
		$output .= '</div>'."\n";
