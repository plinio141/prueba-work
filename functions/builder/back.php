...
// 			),
			...
			array(
				...
				'options' 	=> array(
					...
					'dark' 									=> 'Dark | dark',
					'equal-height'							=> 'Equal Height of Columns in wrap | equal-height',
...
// 				'sub_desc' 	=> __('Content Position within Wraps', 'mfn-opts'),
// 				'options' 	=> array(
// 					'' 			=> '-- Default --',
// 					'top'		=> 'Top',
// 					'middle'	=> 'Middle',
			...
			'portfolio' => array(
				...
				'fields'	=> array(
					...
					array(
						...
						'title'		=> __('Multiple Categories', 'mfn-opts'),
						'sub_desc'	=> __('Categories Slugs', 'mfn-opts'),
						'desc'		=> __('<b>Slugs</b> should be separated with <strong>coma</strong> (,).', 'mfn-opts'),
					),
					...
					array(
						...
						'desc' 		=> __('Exclude current Project', 'mfn-opts'),
					),
