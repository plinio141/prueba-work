...
/* Responsive */
	<?php if( mfn_opts_get('responsive') && mfn_opts_get('font-size-responsive') ): ?>
		...
		@media only screen and (min-width: 768px) and (max-width: 959px){
			...
			.column_column ul, .column_column ol, .column_visual ul, .column_visual ol, .mfn-acc ul, .mfn-acc ol, 
			.ui-tabs-panel ul, .ui-tabs-panel ol, .the_content_wrapper ul, .the_content_wrapper ol { font-size: 14px; line-height: 19px; }
		}
		...
		@media only screen and (min-width: 480px) and (max-width: 767px){
			...
			.column_column ul, .column_column ol, .column_visual ul, .column_visual ol, .mfn-acc ul, .mfn-acc ol, 
			.ui-tabs-panel ul, .ui-tabs-panel ol, .the_content_wrapper ul, .the_content_wrapper ol { font-size: 13px; line-height: 16px; }
		}
